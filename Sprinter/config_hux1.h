...
float axis_steps_per_unit[] = {80, 80, 4571.43,1000}; 
...
#define PID_INTEGRAL_DRIVE_MAX 128
#define PID_PGAIN 1.10 //100 is 1.0
#define PID_IGAIN 0.01 //100 is 1.0
#define PID_DGAIN 1.0 //100 is 1.0
#endif
...
****************************************************************************************/
 ...
 #error Oops!  Make sure you have 'Arduino Mega' selected from the 'Tools -> Boards' menu.
  ...
  #define HEATER_1_PIN       8//10 // THIS LINE FOR V1.1
#ifndef THERMOCOUPLE
  #define TEMP_1_PIN          2//1   // MUST USE ANALOG INPUT NUMBERING NOT DIGITAL OUTPUT NUMBERING!!!!!!!!!
#endif
  
  #define HEATER_0_PIN        10//8
  #define TEMP_0_PIN          1//2
